...
- Develop a classification model that predicts student dropout.
- Analyze key factors influencing student retention.
- Evaluate model performance using standard classification metrics.
- Extract actionable insights for institutional decision-making.
...
These features collectively capture student background and performance patterns.
...
### 🔹 Classification Report (Dropout Class - 1)
